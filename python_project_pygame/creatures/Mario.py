...
from classes.anim import Animation
from classes.Camera import Camera
from classes.Collider import Collider
from classes.creature_collider import CreatureCollider
from classes.Input import Input
from classes.Sprites import Sprites
from creatures.Creatures_database import CreatureBase
from creatures.Mushroom import RedMushroom
from movement.movements import bounceTrait
from movement.movements import GoTrait
from movement.movements import JumpTrait
...
class Mario(CreatureBase):
    def __init__(self, x, y, level, screen, dashboard, sound, gravity=0.8):
        ...
        self.screen = screen
        self.EntityCollider = CreatureCollider(self)
