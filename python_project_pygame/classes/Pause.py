...
class Pause:
    def __init__(self, screen, entity, dashboard):
        ...
        self.state = 0
        self.spritesheet = Spriteheet("./images/screen.png")
        self.pause_srfc = Blur().filter(self.screen, 0, 0, 640, 480)
    ...
    def update(self):
        ...
        self.dashboard.drawText("RESUME", 150, 280, 32)
